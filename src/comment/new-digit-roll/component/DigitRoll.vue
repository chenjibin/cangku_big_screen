...
export default {
  ...
  data() {
    ...
    const divList = arrayFromCache(10).map((n, i) =>  {
      return `<div><img style="height: 160px;width: auto;" src="http://tm.xyyzi.com:9099/oa/test/image/num_${i}.png"/></div>`
    });
  ...
  methods: {
    ...
    beginCssRoll(dis, i, cb, opt) {
      ...
      this.beginCssRoll = (aDis, ai, aCb, aOpt) => {
        ...
        const $curBar = $list.querySelector(`li.num-item-${ai} .d-roll-bar`)
